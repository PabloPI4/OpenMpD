...
float tiempo_trans;
 ...
 if(argC != 6) {
  ...
  float re = atof(argV[2]);
                ...
                c=re+im*
# 115 "prueba_julia.c" 3 4
                       (__extension__ 1.0iF)
# 115 "prueba_julia.c"
                        ;

 printf("JuliaSet: %d, %d, %f, %f, %f, %d\n", width, height,
# 117 "prueba_julia.c" 3 4
                                                           __builtin_tgmath (crealf, creal, creall, ((
# 117 "prueba_julia.c"
                                                           c
# 117 "prueba_julia.c" 3 4
                                                           )))
# 117 "prueba_julia.c"
                                                                   ,
# 117 "prueba_julia.c" 3 4
                                                                    __builtin_tgmath (cimagf, cimag, cimagl, ((
# 117 "prueba_julia.c"
                                                                    c
# 117 "prueba_julia.c" 3 4
                                                                    )))
