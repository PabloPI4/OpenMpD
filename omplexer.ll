...
task_async				 { return TASK_ASYNC; }
alloc 					  { yy_push_state(ALLOC_STATE); return ALLOC; }
broad					  { yy_push_state(BROAD_STATE); return BROAD; }
scatter 				  { yy_push_state(SCATTER_STATE); return SCATTER; }
gather					  { yy_push_state(GATHER_STATE); return GATHER; }
allgather 				  { yy_push_state(ALLGATHER_STATE); return ALLGATHER; }
halo					  { yy_push_state(HALO_STATE); return HALO; }
allreduction 			  { yy_push_state(REDUCTION_STATE); return ALLREDUCTION; }
...
<ALLOC_STATE>"("                          { return '('; }
<ALLOC_STATE>")"                          { yy_pop_state(); return ')'; }
<ALLOC_STATE>{blank}*                     { ; }
<ALLOC_STATE>.                            { yy_push_state(EXPR_STATE); current_string = yytext[0]; }

<BROAD_STATE>"("                          { return '('; }
<BROAD_STATE>")"                          { yy_pop_state(); return ')'; }
<BROAD_STATE>{blank}*                     { ; }
<BROAD_STATE>.                            { yy_push_state(EXPR_STATE); current_string = yytext[0]; }

<HALO_STATE>"("                          { return '('; }
<HALO_STATE>")"                          { yy_pop_state(); return ')'; }
<HALO_STATE>","                          { return ','; }
<HALO_STATE>":"                          { return ':'; }
<HALO_STATE>{blank}*                     { ; }
<HALO_STATE>chunk/{blank}*		 { return CHUNK; }
<HALO_STATE>.                            { yy_push_state(EXPR_STATE); current_string = yytext[0]; }

<SCATTER_STATE>"("                          { return '('; }
<SCATTER_STATE>")"                          { yy_pop_state(); return ')'; }
<SCATTER_STATE>","                          { return ','; }
<SCATTER_STATE>":"                          { return ':'; }
<SCATTER_STATE>{blank}*                     { ; }
<SCATTER_STATE>chunk/{blank}*				{return CHUNK; }
<SCATTER_STATE>.                            { yy_push_state(EXPR_STATE); current_string = yytext[0]; }

<GATHER_STATE>"("                          { return '('; }
<GATHER_STATE>")"                          { yy_pop_state(); return ')'; }
<GATHER_STATE>","                          { return ','; }
<GATHER_STATE>":"                          { return ':'; }
<GATHER_STATE>{blank}*                     { ; }
<GATHER_STATE>chunk/{blank}*				{return CHUNK; }
<GATHER_STATE>.                            { yy_push_state(EXPR_STATE); current_string = yytext[0]; }

<ALLGATHER_STATE>"("                          { return '('; }
<ALLGATHER_STATE>")"                          { yy_pop_state(); return ')'; }
<ALLGATHER_STATE>","                          { return ','; }
<ALLGATHER_STATE>":"                          { return ':'; }
<ALLGATHER_STATE>{blank}*                     { ; }
<ALLGATHER_STATE>chunk/{blank}*				{return CHUNK; }
<ALLGATHER_STATE>.                            { yy_push_state(EXPR_STATE); current_string = yytext[0]; }
